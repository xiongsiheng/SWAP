...
generator_adapter="${GENERATOR_ADAPTER:-$repo_root/checkpoints/SWAP_ReClor_Gen_Llama3-8B-LoRA}"
discriminator_adapter="${DISCRIMINATOR_ADAPTER:-$repo_root/checkpoints/SWAP_ReClor_Disc_Llama3-8B-LoRA}"
